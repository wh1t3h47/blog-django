    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_de', models.CharField(db_index=True, max_length=60, null=True,
                 unique=True, verbose_name='Nome (barra de ferramentas)')),
                ('name_en', models.CharField(db_index=True, max_length=60, null=True,
                 unique=True, verbose_name='Nome (barra de ferramentas)')),
                ('name_pt', models.CharField(db_index=True, max_length=60, null=True,
                 unique=True, verbose_name='Nome (barra de ferramentas)')),
                ('short_name', models.CharField(blank=True,
                 max_length=30, verbose_name='Nome curto (singular)')),
                ('short_name_de', models.CharField(blank=True, max_length=30,
                 null=True, verbose_name='Nome curto (singular)')),
                ('short_name_en', models.CharField(blank=True, max_length=30,
                 null=True, verbose_name='Nome curto (singular)')),
                ('short_name_pt', models.CharField(blank=True, max_length=30,
                 null=True, verbose_name='Nome curto (singular)')),
                ('title', models.CharField(blank=True,
                 max_length=255, verbose_name='Título (página)')),
                ('title_de', models.CharField(blank=True, max_length=255,
                 null=True, verbose_name='Título (página)')),
                ...
                ('published_de', models.BooleanField(
                    db_index=True, default=True, verbose_name='Publicado')),
                ('published_en', models.BooleanField(
                    db_index=True, default=True, verbose_name='Publicado')),
                ('published_pt', models.BooleanField(
                    db_index=True, default=True, verbose_name='Publicado')),
                ('order', models.IntegerField(db_index=True, default=0,
                 verbose_name='Ordem da categoria na listagem')),
                ('video_url', models.CharField(blank=True, max_length=255,
                 null=True, verbose_name='ID do canal do YouTube')),
                ('video_url_de', models.CharField(blank=True, max_length=255,
                 null=True, verbose_name='ID do canal do YouTube')),
                ('video_url_en', models.CharField(blank=True, max_length=255,
                 null=True, verbose_name='ID do canal do YouTube')),
                ('video_url_pt', models.CharField(blank=True, max_length=255,
                 null=True, verbose_name='ID do canal do YouTube')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted_de', models.BooleanField(
                    db_index=True, default=False, verbose_name='Ocultado?')),
                ('is_deleted_en', models.BooleanField(
                    db_index=True, default=False, verbose_name='Ocultado?')),
                ('is_deleted_pt', models.BooleanField(
                    db_index=True, default=False, verbose_name='Ocultado?')),
                ...
                ('galleries', models.ManyToManyField(
                    blank=True, to='FreiRui.galleries')),
            ],
        ),
        migrations.CreateModel(
            name='Images',
